...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            $uniqueGuruList = array_map("unserialize", array_unique(array_map("serialize", $guruList)));
            ?>

            <?php if (!empty($uniqueGuruList)) : ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody style="text-align: center; background-color: bg-;">
                                    <?php $i = 1 ?>
                                    <?php foreach ($uniqueGuruList as $item) : ?>
                                        <tr>
                                            <th scope="row"><?= $i++; ?></th>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ubah Status Guru BK</h5>
            ...
            <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Data Guru BK</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                            ...
                            <form action="<?= url_to('register') ?>" method="post" class="user">
                                ...
                                <div class="form-group">
                                    <select name="asal_sekolah" id="asal_sekolah" placeholder="Asal Sekolah" class="form-control" autocomplete="off" required>
                                        <option value="" disabled selected hidden>Sekolah</option>
