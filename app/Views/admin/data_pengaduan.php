...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- Form Pencarian -->
            <form action="<?= base_url('pengaduan/admin_show') ?>" method="get" class="mb-3">
                <div class="mb-3 d-flex justify-content-start align-items-center">
                    <input type="text" name="keyword" class="form-control ml-auto" placeholder="Cari..." style="max-width: 350px;">
            ...
            <?php if (!empty($pengaduan)) : ?>
                ...
                <form class="form-inline">
					<?= $pager->links('data_pengaduan', 'pagination') ?>
				</form>
            <?php endif; ?>
        </div>
    </div>
